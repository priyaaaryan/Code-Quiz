...
function question1() {
  ...
  // dynamically change the question
  center.innerHTML =
      `<h1 class="font"><b>Commonly used datatypes do not include: </b></h1>
  					   <div style="clear:both;"></div>`;
  // dynamically change the options by adding buttons
  // buttons have relevant callbacks
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(1)">1. strings</button>
  					    <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(1)">2. booleans</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="right(1)">3. alerts</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="wrong(1)">4. numbers</button>
  					   <div style="clear:both;"></div>`;
}
...
function question2() {
  ...
  // dynamically change the question
  center.innerHTML =
      `<h1 class="font"><b>The condition of an if else statement is enclosed with__ </b></h1>
  					   <div style="clear:both;"></div>`;
  // dynamically change the options by adding buttons
  // buttons have relevant callbacks
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(2)">1. quotes</button>
  					    <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(2)">2. curly brackets</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="right(2)">3. parentesis</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="wrong(2)">4. square brackets</button>
  					   <div style="clear:both;"></div>`;
}
// add function to sequence
...
function question3() {
  ...
  center.innerHTML = "";
  center.innerHTML =
      `<h1 class="font"><b>Arrays in JavaScript can be used to store ____</b></h1>
  					   <div style="clear:both;"></div>`;
  // dynamically change the options by adding buttons
  // buttons have relevant callbacks
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(3)">1. numbers and strings</button>
  					    <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(3)">2. other arrays</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="wrong(3)">3. booleans</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="right(3)">4. all the above</button>
  					   <div style="clear:both;"></div>`;
}
// add function to sequence
...
function question4() {
  ...
  center.innerHTML = "";
  center.innerHTML =
      `<h1 class="font"><b>String values must be enclosed within ____ when being assigned to varriables</b></h1>
  					   <div style="clear:both;"></div>`;
  // dynamically change the options by adding buttons
  // buttons have relevant callbacks
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(5)">1. commas</button>
  					    <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(5)">2. curly brackects</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="right(5)">3. quotes</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="wrong(5)">4. parenthesis</button>
  					   <div style="clear:both;"></div>`;
}
// add function to sequence
...
function question5() {
  ...
  // buttons have relevant callbacks
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(6)">1. JavaScript</button>
  					    <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left" onclick="wrong(6)">2. terminal/bash</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="wrong(6)">3. for loops</button>
  					   <div style="clear:both;"></div>`;
  center.innerHTML +=
      `<button  class="btn left"onclick="right(6)">4. console.log</button>
  					   <div style="clear:both;"></div>`;
}
// add function to sequence
...
function results() {
 ...
 center.innerHTML = `<h1 class="font">
  ...
  center.innerHTML +=
      `<h3 style="font-size: 20px;">Your Final Score is ${score}</h3>
  					    <div style="clear:both;"></div>`;
  // dynamically add input element to string for user name
  center.innerHTML +=
      `<p style="float:left;font-size: 20px;">Enter Initials:&nbsp;</p>`;
  center.innerHTML +=
      `<input style="float:left;" type="text" id="fname" name="fname" value="">`;
  // dynamically add buttons to receive the users initials
  center.innerHTML +=
      `<button style="float:left;padding: 7px 17px;" class="btn"onclick="take_fname()">Submit</button>`;
}
// add function to sequence
...
function high_scores_func() {
 ...
 document.getElementById("mark").style.display = "node"
  ...
  high_scores.forEach(function(item,index){
  	center.innerHTML += `${index+1}. &nbsp; ${item.fname} - ${item.score}<br><br>`
  });
  // dynamically  add go back button
  center.innerHTML +=
      `<button  style="padding: 7px 17px;" class="btn" onclick="restore_start_page()">go back</button>`;
  // dynamically add object to clear hing scores
  center.innerHTML +=
      `<button  style="padding: 7px 17px;" class="btn" onclick="clear_high_scores()">clear high scores</button>`;
